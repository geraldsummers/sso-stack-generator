...
const evidenceRules = new Map<string, EvidenceRule>([
  ...
  ['progression/bookstack-ownership', { label: 'Progression BookStack access task', pattern: /Protect BookStack with central login|Access BookStack Route Defined/i }],
  ...
  ['progression/command-reveal', { label: 'Progression revealed stackctl command', pattern: /stackctl verify access\.bookstack/i }],
  ['progression/ops-cockpit', { label: 'Progression stack capability proof', pattern: /Access BookStack Route Defined|First Service Seen|State Mapped/i }],
